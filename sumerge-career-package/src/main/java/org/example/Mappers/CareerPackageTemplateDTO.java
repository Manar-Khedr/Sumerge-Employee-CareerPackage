...
public class CareerPackageTemplateDTO {
    ...
    public CareerPackageTemplateDTO(int positionTitle, int requiredExperienceProfiles, int totalLearningHoursRequired, int knowledgeSharingSessionsRequired, int improvementInitiativesRequired) {
